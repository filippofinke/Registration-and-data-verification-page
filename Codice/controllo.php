    ...
    <div id="container" class="container center-align">
      ...
      <table class="table">
        <tbody>
          ...
          <tr>
            <th>Genere</th>
            <td><?php echo ($gender == "M")?"Maschio":"Femmina"; ?></td>
          </tr>
          <tr>
            <th>Via</th>
      ...
      <div class="row">
        <div class="input-field col s6">
          <button id="correctButton" class="btn btn-large btn-register waves-effect waves-light btn-color" type="reset">Correggi
